...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"src/helpers/validate-ip.js":[function(require,module,exports) {
"use strict";
...
;
},{}],"src/helpers/create-elements.js":[function(require,module,exports) {
"use strict";
...
var ipTimezone = document.getElementById('timezone');
var ipIsp = document.getElementById('isp');

function fillInfo(obj) {
  var _obj$location = obj.location,
      region = _obj$location.region,
      country = _obj$location.country,
      timezone = _obj$location.timezone;
  ipInfo.innerText = obj.ip;
  ipLocation.innerText = "".concat(country, " ").concat(region);
...
Object.defineProperty(exports, "fillInfo", {
  enumerable: true,
  get: function () {
    return _createElements.fillInfo;
  }
});
...
var _createElements = require("./create-elements");
},{"./validate-ip":"src/helpers/validate-ip.js","./create-elements":"src/helpers/create-elements.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var btn = document.querySelector('.search-bar__btn'); //Events

btn.addEventListener('click', getData);
searchInput.addEventListener('keydown', handleEnter); //Basic logic

function getData() {
  if ((0, _helpers.validateIp)(searchInput.value)) {
    fetch("https://geo.ipify.org/api/v2/country?apiKey=at_VG1G7WJzfuHLWQc6m3rBS0FCoIQaP&ipAddress=".concat(searchInput.value)).then(function (response) {
      return response.json();
    }).then(_helpers.fillInfo);
  }
}
...
function initMap() {
  ...
  myMap.geoObjects.add(new ymaps.Placemark([43.9785, 15.38404], {
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./helpers":"src/helpers/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
